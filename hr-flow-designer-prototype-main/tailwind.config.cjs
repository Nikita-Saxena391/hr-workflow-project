...
module.exports = {
  ...
  content: [
    "./index.html",
    "./src/**/*.{js,ts,jsx,tsx}",
    // Scan UI library so its Tailwind classes aren't purged
    "./node_modules/@blinkdotnew/ui/dist/index.mjs",
  ],
  theme: {
    extend: {
      // ── Border radius — must match UI library's tailwind.config.ts ──
      borderRadius: {
        sm:   'var(--radius-sm)',
        md:   'var(--radius-md)',
        lg:   'var(--radius-lg)',
      ...
      // ── Box shadows — must match UI library's tailwind.config.ts ────
      boxShadow: {
        sm:      'var(--shadow-sm)',
